 ...
 * description :
 */
public abstract class BaseActivity<DB extends ViewDataBinding> extends SupportActivity implements IBaseView, Consumer<Disposable> {
    ...
    public void initCommonView() {
        ...
        mLoadService = builder.build().register(mBinding.getRoot(), layoutParams, (Callback.OnReloadListener) BaseActivity.this::onReload);
